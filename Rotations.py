...
def simSteps(experiment,timestep):
    """ This function was generated to remove the need for two functions below. **not yet implemented """
    if experiment == 1:
        seconds = 10
    elif experiment == 2:
        seconds = 14
...
def set_target_thetas(num_steps, pid, experiment,simStep,physics_engine):
...
def set_target_thetasVR(num_steps, pid, experiment, simStep,physics_engine):
